...
Desafíos:Saber cómo usar funciones es uno de los conceptos fundamentales en la programación 
y el desarrollo de software. Las funciones desempeñan un papel crucial en la organización,
 modularización y reutilización del código.

Con eso en mente, hemos creado una lista de actividades (opcionales) centradas en la 
práctica para mejorar aún más tu experiencia de aprendizaje.
...
function calcularFactorial(numeroF) {
  if (numeroF === 0 || numeroF === 1) {
    return 1;
  } else {
    return numeroF * calcularFactorial(numeroF - 1);
  }
}
// Ejemplo de uso
let numeroA = 5;
let resultado = calcularFactorial(numeroA);
console.log(`El factorial de ${numeroA} es ${resultado}`);

// 3.Crea una función que convierta un valor en dólares, pasado como parámetro,
//  y devuelva el valor equivalente en reales. Para esto, considera la cotización
